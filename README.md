...
2. Create a Google application following the section **Creating a Google application** of the **Android - Using the SDK** pdf, and place the `google-services.json` file in the `./platforms/android/app` folder.



3. Add this **android:name** property and value to the **application** tag in the `./platforms/android/app/src/main/AndroidManifest.xml` file:



```xml

<application ... android:name="com.selligent.SelligentApplication">
...
4. Bind a callback to the button created in the previous step
